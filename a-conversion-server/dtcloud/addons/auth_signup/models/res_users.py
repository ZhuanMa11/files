...
from dtcloud.tools.misc import ustr

from dtcloud.addons.base.models.ir_mail_server import MailDeliveryException
from dtcloud.addons.auth_signup.models.res_partner import SignupError, now
