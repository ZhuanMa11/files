...
from dtcloud.http import Controller, dispatch_rpc, request, route
from dtcloud.service import wsgi_server
from dtcloud.fields import Date, Datetime
from dtcloud.tools import lazy


class DTCloudMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = DTCloudMarshaller
...
class RPC(Controller):
    ...
    def jsonrpc(self, service, method, args):
        """ Method used by client APIs to contact DTCloud. """
