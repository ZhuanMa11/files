...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.dtcloud360.com">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as DTCloud and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this DTCloud mailinglist, but when you start implying that Postgres
...
HOTMAIL_1 = u"""<div>
    <div dir="ltr"><br>
        I have an amazing company, i'm learning DTCloud, it is a small company yet, but plannig to grow up quickly.
        <br><br>Kindest regards,<br>xxx<br>
        <div>
            <div id="SkyDrivePlaceholder">
            </div>
            <hr id="stopSpelling">
            Subject: Re: your dtcloud360.com registration<br>From: xxx@xxx.xxx<br>To: xxx@xxx.xxx<br>Date: Wed, 27 Mar 2013 17:12:12 +0000
            <br><br>
            Hello xxx,
            <br>
            I noticed you recently created an dtcloud360.com account to access DTCloud Apps.
            <br>
            You indicated that you wish to use DTCloud in your own company.
            ...
            Best regards,<br>
            <pre>
                <a href="http://dtcloud360.com" target="_blank">http://dtcloud360.com</a>
...
HOTMAIL_1_OUT = [
    ...
    u"""<pre data-o-mail-quote="1">
                <a href="http://dtcloud360.com" target="_blank" data-o-mail-quote="1">http://dtcloud360.com</a>
                Belgium: +32.81.81.37.00
                U.S.: +1 (650) 307-6736
                India: +91 (79) 40 500 100
            </pre>"""]
...
<div class="WordSection1">
        ...
        <p class="MsoNormal">
            <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;;color:#1F497D">
                ...
                If we adopt DTCloud we will probably move to Linux or look for a hosted SaaS option.
            </span>
        </p>
        <p></p>
        <p></p>
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        DTCloud Enterprise [mailto:sales@dtcloud360.com]
                        <br><b>Sent:</b> Monday, 11 March, 2013 14:47<br><b>To:</b> Alan Widmer<br><b>Subject:</b> Re: your dtcloud360.com registration
                    </span>
                </p>
                <p></p>
                <p></p>
        ...
        <p></p>
        <p>I noticed you recently downloaded DTCloud. </p>
        <p></p>
        <p>
            Uou mentioned you wish to use DTCloud in your own company. Please let me more about your
            business needs and requirements? When will you be available to discuss about your project?
        </p>
        <p></p>
        <p>Thanks for your interest in DTCloud, </p>
        <p></p>
        ...
        <pre>--<p></p></pre>
        <pre>Nicolas<p></p></pre>
        <pre><a href="http://dtcloud360.com">http://dtcloud360.com</a><p></p></pre>
...
MSOFFICE_1_OUT = [u'I noticed you recently downloaded DTCloud.', 'Uou mentioned you wish to use DTCloud in your own company.', 'Belgium: +32.81.81.37.00']
...
B-1367 Gérompont
Tel: +32.81.81.37.00
Web: http://www.dtcloud360.com</pre>"""
...
B-1367 Gérompont
Tel: +32.81.81.37.00
Web: http://www.dtcloud360.com"""]


REMOVE_CLASS = u"""
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed DTCloud 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">DTCloud Error<span class="o_subtitle text-muted"></span></h4>
                </div>
