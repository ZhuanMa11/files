...
from dtcloud.exceptions import AccessError, ValidationError
from dtcloud.tests import common
from dtcloud.tools import mute_logger, view_validation
from dtcloud.addons.base.models.ir_ui_view import (
...
class TestApplyInheritanceSpecs(ViewCase):
    ...
    @mute_logger('dtcloud.addons.base.models.ir_ui_view')
...
class TestViews(ViewCase):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view'):
        with self.assertRaises(ValidationError) as catcher, mute_logger('dtcloud.addons.base.models.ir_ui_view'):
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('dtcloud.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
