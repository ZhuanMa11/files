...
from dtcloud.modules import load_information_from_description_file
from dtcloud.tools import convert_file, exception_to_unicode
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the DTCloud Studio app."))
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempfile.TemporaryDirectory() as module_dir:
                import dtcloud.modules.module as module
                try:
                    dtcloud.addons.__path__.append(module_dir)
                    ...
                    dtcloud.addons.__path__.remove(module_dir)
