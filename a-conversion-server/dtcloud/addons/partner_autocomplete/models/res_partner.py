...
import logging
import json
from dtcloud import api, fields, models, exceptions, _
...
DEFAULT_ENDPOINT = 'https://partner-autocomplete.dtcloud360.com'
    ...
    def create(self, vals_list):
        ...
        if len(vals_list) == 1:
            ...
            if partners.additional_info:
                ...
                template_values['flavor_text'] = _("Partner created by DTCloud Partner Autocomplete Service")
