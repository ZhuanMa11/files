dtcloud.define('partner_autocomplete.tests', function (require) {
    "use strict";
    ...
    var suggestions = [{
        name: "DTCloud",
        website: "dtcloud360.com",
        domain: "dtcloud360.com",
        logo: "dtcloud360.com/logo.png",
        vat: "BE0477472701"
    }];
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "dtcloud360.com/logo.png" ? "dtcloudbase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getDTCloudSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getDTCloudSuggestions(value);
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "dtcloud")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "dtcloud360.com/logo.png"
                    || route === "data:image/png;base64,dtcloudbase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "dtcloud");
            ...
            assert.strictEqual($input.val(), "DTCloud", "Input value should have been updated to \"DTCloud\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "dtcloud360.com", "website value should have been updated to \"dtcloud360.com\"");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing dtcloud letters again");
