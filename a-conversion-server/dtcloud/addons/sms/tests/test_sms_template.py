...
from dtcloud.tests.common import SavepointCase, users
from dtcloud.addons.mail.tests.common import mail_new_test_user
...
class TestSmsTemplateAccessRights(SavepointCase):
    ...
    @users('user_system')
    @mute_logger('dtcloud.models.unlink', 'dtcloud.addons.base.models.ir_model')
