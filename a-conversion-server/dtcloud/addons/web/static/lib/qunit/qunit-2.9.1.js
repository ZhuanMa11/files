...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("DTCloudBeforeTestHook", "DTCloudAfterTestHook"); // DTCloud customization
  ...
  Test.prototype = {
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("DTCloudBeforeTestHook"); // DTCloud customization
  	...
  	finish: function finish() {
        ...
        emit("DTCloudAfterTestHook", { moduleName: this.module.name, testName: this.testName }); // DTCloud customization
