dtcloud.define('web.Apps', function (require) {
"use strict";
    ...
    start: function() {
        ...
        return new Promise(function (resolve, reject) {
            self.get_client().then(function (client) {
                ...
                self.do_warn(_t('DTCloud Apps will be available soon'), _t('Showing locally available modules'), true);
                return self._rpc({
