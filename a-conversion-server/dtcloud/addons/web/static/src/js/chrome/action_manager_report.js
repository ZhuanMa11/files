dtcloud.define('web.ReportActionManager', function (require) {
"use strict";

/**
 * The purpose of this file is to add the support of DTCloud actions of type
...
var WKHTMLTOPDF_MESSAGES = {
    ...
    workers: _lt('You need to start DTCloud with at least two workers to print a pdf version of ' +
                 'the reports.'),
};
