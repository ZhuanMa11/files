dtcloud.define('web.WebClient', function (require) {
"use strict";
...
return AbstractWebClient.extend({
    ...
    bind_events: function () {
        ...
        /*
            Small patch to allow having a link with a href towards an anchor. Since dtcloud use hashtag
    ...
    load_menus: function () {
        return (dtcloud.loadMenusPromise || dtcloud.reloadMenus())
