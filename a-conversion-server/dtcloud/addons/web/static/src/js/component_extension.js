(function () {
    /**
     * Symbol used in ComponentWrapper to redirect Owl events to DTCloud legacy
     * events.
     */
    dtcloud.widgetSymbol = Symbol('widget');
    ...
    owl.Component.prototype.__trigger = function (component, evType, payload) {
        if (this.env[dtcloud.widgetSymbol]) {
            this.env[dtcloud.widgetSymbol](evType);
        }
