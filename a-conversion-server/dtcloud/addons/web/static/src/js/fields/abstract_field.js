dtcloud.define('web.AbstractField', function (require) {
"use strict";
...
var AbstractField = Widget.extend({
    ...
    */
     ...
     *
     * @param {any} record
     * @param {DTCloudEvent} [event] an event that triggered the reset action. It
     ...
     * @private
     * @param {any} record
     * @param {DTCloudEvent} event the event that triggered the change
     */
