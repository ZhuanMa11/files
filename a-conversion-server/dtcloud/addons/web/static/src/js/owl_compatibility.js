dtcloud.define('web.OwlCompatibility', function () {
    "use strict";

    /**
     * This file defines the necessary tools for the transition phase where DTCloud
    ...
    const widgetSymbol = dtcloud.widgetSymbol;
     ...
     * adapter for Owl components that embed DTCloud legacy widgets (or dynamically
     * both Owl components and DTCloud legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect DTCloud legacy events to OWL events.
         *
         * @private
         * @param {DTCloudEvent} ev
         */
        _trigger_up(ev) {
     ...
     * together when an DTCloud legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * DTCloud legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
