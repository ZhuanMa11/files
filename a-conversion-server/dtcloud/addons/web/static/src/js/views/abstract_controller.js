dtcloud.define('web.AbstractController', function (require) {
"use strict";

/**
 * The Controller class is the class coordinating the model and the renderer.
 * It is the C in MVC, and is what was formerly known in DTCloud as a View.
 *
...
var AbstractController = mvc.Controller.extend(ActionMixin, {
    ...
    /**
     * When an DTCloud event arrives requesting a record to be opened, this method
