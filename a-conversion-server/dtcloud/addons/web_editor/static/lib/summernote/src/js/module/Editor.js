define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // dtcloud: allow access for override
    this.table = table;   // dtcloud: allow access for override
    this.typing = typing; // dtcloud: allow access for override
    this.bullet = bullet; // dtcloud: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // dtcloud: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // dtcloud: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // dtcloud: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // dtcloud: addition
        $(anchor).css(linkInfo.style || {}); // dtcloud: addition
        if (isNewWindow) {
