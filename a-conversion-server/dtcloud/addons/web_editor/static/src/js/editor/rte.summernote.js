dtcloud.define('web_editor.rte.summernote', function (require) {
'use strict';
...
// outside the iframe.
const topBus = window.top.dtcloud.__DEBUG__.services['web.core'].bus;
...
// DTCloud editor coming in future versions.
...
renderer.createPalette = function ($container, options) {
    ...
    const parent = dtcloud.__DEBUG__.services['root.widget'];
...
// Translation for dtcloud
$.summernote.lang.dtcloud = {
    font: {
      bold: _t('Bold'),
      italic: _t('Italic'),
