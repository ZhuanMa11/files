dtcloud.define('web_editor.wysiwyg.root', function (require) {
'use strict';
...
var WysiwygRoot = Widget.extend({
    ...
    willStart: function () {
        ...
        return this._super().then(function () {
            ...
            if (!assetsLoaded) {
                var Wysiwyg = dtcloud.__DEBUG__.services['web_editor.wysiwyg'];
    ...
    _getWysiwygContructor: function () {
        return dtcloud.__DEBUG__.services['web_editor.wysiwyg'];
    }
});
...
dtcloud.define('web_editor.wysiwyg.default_options', function (require) {
'use strict';
