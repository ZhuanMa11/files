dtcloud.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in dtcloud.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" dtcloud domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in dtcloud.
 */
...
/**
 * Let users choose a document, including uploading a new document in dtcloud.
 */
