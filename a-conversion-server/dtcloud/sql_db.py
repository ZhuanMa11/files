...
"""
The PostgreSQL connector is a connectivity layer between the DTCloud code and
...
from dtcloud.api import Environment
...
class Cursor(BaseCursor):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as DTCloud, we need the best guarantees that no data
        ...
        DTCloud implements its own level of locking protection
        ...
        the default transaction isolation level for DTCloud cursors, as
...
def close_db(db_name):
    """ You might want to call dtcloud.modules.registry.Registry.delete(db_name) along this function."""
    global _Pool
    if _Pool:
