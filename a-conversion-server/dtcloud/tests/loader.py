...
from .. import tools
from .common import TagsSelector, DTCloudSuite
from .runner import DTCloudTestResult
...
def get_test_modules(module):
    ...
    results = _get_tests_modules('dtcloud.addons', module)

    try:
        importlib.import_module('dtcloud.upgrade.%s' % module)
    except ImportError:
        pass
    else:
        results += _get_tests_modules('dtcloud.upgrade', module)
