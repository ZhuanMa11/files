...
class _LogTracer(object):
    ...
    def tracer(self, frame, event, arg):
        ...
        if not isinstance(in_self, dtcloud.models.BaseModel):
            return self.tracer
...
def profile(method=None, whitelist=None, blacklist=(None,), files=None,
    ...
    """
        ...
        all methods for all dtcloud models by applying the optional filters.
        ...
        :param list blacklist: list model names to remove from the log
                        (Default: remove non dtcloud model from the log: [None])
        ...
        .. code-block:: python
          ...
          from dtcloud.tools.profiler import profile
          ...
          class SaleOrder(models.Model):
            ...
            ...
            @profile()                  # log all methods for all dtcloud models
            def unlink(self):
            ...
            @profile(whitelist=['sale.order', 'ir.model.data'])
            def action_quotation_send(self):
            ...
            @profile(files=['/home/openerp/dtcloud/dtcloud/addons/sale/models/sale.py'])
            def write(self):
            ...
    ...
    def _dtcloudProfile(method, *args, **kwargs):
    ...
    if not method:
        return lambda method: decorator(_dtcloudProfile, method)

    wrapper = decorator(_dtcloudProfile, method)
    return wrapper
