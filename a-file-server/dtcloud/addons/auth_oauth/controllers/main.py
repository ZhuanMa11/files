...
from dtcloud import api, http, SUPERUSER_ID, _
from dtcloud.exceptions import AccessDenied
from dtcloud.http import request
from dtcloud import registry as registry_get

from dtcloud.addons.auth_signup.controllers.main import AuthSignupHome as Home
from dtcloud.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via DTCloud Account provider"""
