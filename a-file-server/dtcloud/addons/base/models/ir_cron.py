...
from dtcloud.exceptions import UserError

_logger = logging.getLogger(__name__)

BASE_VERSION = dtcloud.modules.load_information_from_description_file('base')['version']
...
class ir_cron(models.Model):
    ...
    def _callback(self, cron_name, server_action_id, job_id):
        ...
        try:
            ...
            dtcloud.netsvc.log(_logger, logging.DEBUG, 'cron.object.execute', (self._cr.dbname, self._uid, '*', cron_name, server_action_id), depth=log_depth)
            start_time = False
        ...
        try:
            ...
            for job in jobs:
                ...
                try:
                    ...
                    job_cr = db.cursor()
                    try:
                        registry = dtcloud.registry(db_name)
    ...
    def _acquire_job(cls, db_name):
        ...
        try:
            ...
            if e.pgcode == '42P01':
                ...
                # The table ir_cron does not exist; this is probably not an DTCloud database.
