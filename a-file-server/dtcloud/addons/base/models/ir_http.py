...
from dtcloud.exceptions import AccessDenied, AccessError, MissingError
from dtcloud.http import request, content_disposition
from dtcloud.tools import consteq, pycompat
from dtcloud.tools.mimetypes import guess_mimetype
from dtcloud.modules.module import get_resource_path, get_module_path

from dtcloud.http import ALLOWED_DEBUG_MODES
from dtcloud.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(dtcloud.conf.server_wide_modules)
