...
from dtcloud.tests.common import TransactionCase, can_import
from dtcloud.modules.module import get_module_resource
from dtcloud.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('dtcloud.addons.base_import.models.base_import')
