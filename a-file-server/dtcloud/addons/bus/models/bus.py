...
import dtcloud
from dtcloud import api, fields, models, SUPERUSER_ID
from dtcloud.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class ImBus(models.Model):
    ...
    def sendmany(self, notifications):
        ...
        if channels:
            ...
            def notify():
                with dtcloud.sql_db.db_connect('postgres').cursor() as cr:
...
dispatch = None
if not dtcloud.multi_process or dtcloud.evented:
