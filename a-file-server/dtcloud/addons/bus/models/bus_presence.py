...
from dtcloud.addons.bus.models.bus import TIMEOUT
from dtcloud.service.model import PG_CONCURRENCY_ERRORS_TO_RETRY
...
class BusPresence(models.Model):
    ...
    def _update(self, inactivity_period):
        ...
        if not presence:  # create a new presence for the user
            ...
            with tools.mute_logger('dtcloud.sql_db'):
