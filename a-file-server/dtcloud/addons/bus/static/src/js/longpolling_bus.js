dtcloud.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether dtcloud is focused or not
     *
     * @returns {boolean}
     */
    isDTCloudFocused: function () {
        return this._isDTCloudFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isDTCloudFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isDTCloudFocused);
        }
    },
    /**
