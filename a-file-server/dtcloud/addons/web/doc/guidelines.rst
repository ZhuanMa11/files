...
example in DTCloud is dashboards), queries should be restricted to a
...
DTCloud Web's :js:class:`~openerp.web.Widget` has an attribute
...
From v11, we introduce a new coding standard for DTCloud Javascript code.  Here it
is:

* add "use strict"; on top of every dtcloud JS module
