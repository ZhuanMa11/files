...
from dtcloud import api, models
from dtcloud.http import request
from dtcloud.tools import ustr

from dtcloud.addons.web.controllers.main import module_boot, HomeStaticTemplateHelpers
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = dtcloud.service.common.exp_version()
