...
See https://github.com/dtcloud/owl/blob/master/doc/reference/config.md#mode for more information.`);
            }
            else {
    ...
    class Component {
         ...
         *  - it can be patched (useful in dtcloud ecosystem)
  ...
  `;
    ...
    __info__.url = 'https://github.com/dtcloud/owl';
