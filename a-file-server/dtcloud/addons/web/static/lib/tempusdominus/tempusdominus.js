...
var DateTimePicker = function ($, moment) {
    ...
    var DateTimePicker = function () {
        ...
        DateTimePicker.prototype._change = function _change(e) {
            ...
            this._setValue(parsedDate, 0); // DTCloud FIX: if a valid date is replaced by an invalid one, lib will crash, see https://github.com/tempusdominus/bootstrap-4/issues/223
        ...
        DateTimePicker.prototype._notifyEvent = function _notifyEvent(e) {
            // /!\ dtcloud FIX: these next conditions have been modified by dtcloud
        ...
        DateTimePicker.prototype._getLastPickedDate = function _getLastPickedDate() {
            return this._dates[this._getLastPickedDateIndex()] || this.getMoment(); // FIXME changed by DTCloud
        };
...
var TempusDominusBootstrap4 = function ($) {
    ...
    var TempusDominusBootstrap4 = function (_DateTimePicker) {
        ...
        TempusDominusBootstrap4.prototype._place = function _place(e) {
            ...
            // /!\ dtcloud FIX: the 3 next lines have been *added* by dtcloud
    ...
    */
    ...
    $(document).on(DateTimePicker.Event.CLICK_DATA_API, DateTimePicker.Selector.DATA_TOGGLE, function () {
        ...
        // /!\ dtcloud FIX: check on 'config' existence added by dtcloud
