dtcloud.define('web.AbstractWebClient', function (require) {
"use strict";
...
var AbstractWebClient = Widget.extend(KeyboardNavigationMixin, {
    ...
    init: function (parent) {
        // a flag to determine that dtcloud is fully loaded
        dtcloud.isReady = false;
        this.client_options = {};
        this._super(parent);
        ...
        this.set('title_part', {"zopenerp": "DTCloud"});
        this.env = env;
