dtcloud.define("web.commonEnv", function (require) {
    "use strict";

    /**
     * This file defines the common environment, which contains everything that
     * is needed in the env for both the backend and the frontend (DTCloud
     ...
     * on environments.
     *
     * [1] https://github.com/dtcloud/owl/blob/master/doc/reference/environment.md#content-of-an-environment
     */
