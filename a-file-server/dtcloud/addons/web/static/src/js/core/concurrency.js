dtcloud.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in DTCloud.
 *
 * The basic concurrency primitives in DTCloud JS are the callback, and the
...
return {
    ...
    /**
     * A (DTCloud) mutex is a primitive for serializing computations.  This is
