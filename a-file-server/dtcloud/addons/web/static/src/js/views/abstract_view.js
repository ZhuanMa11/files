dtcloud.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. DTCloud JS views are the
 ...
 * the word 'view' has historical significance in DTCloud code, so we replaced the
