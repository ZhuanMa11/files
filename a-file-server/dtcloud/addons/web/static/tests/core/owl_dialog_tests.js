dtcloud.define('web.owl_dialog_tests', function (require) {
    "use strict";
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for DTCloud modal...
            ...
            // Title (default: 'DTCloud')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "DTCloud" + "The Subtitle",
