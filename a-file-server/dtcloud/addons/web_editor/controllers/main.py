...
from dtcloud import http, tools, _, SUPERUSER_ID
from dtcloud.addons.http_routing.models.ir_http import slug
from dtcloud.exceptions import UserError
from dtcloud.modules.module import get_module_path, get_resource_path
from dtcloud.tools.misc import file_open

from ..models.ir_attachment import SUPPORTED_IMAGE_MIMETYPES

logger = logging.getLogger(__name__)
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.dtcloud360.com'
