...
from dtcloud.sql_db import TestCursor
from dtcloud.tools import (config, existing_tables, ignore,
                        lazy_classproperty, lazy_property, sql, OrderedSet)
from dtcloud.tools.lru import LRU

_logger = logging.getLogger(__name__)
_schema = logging.getLogger('dtcloud.schema')
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # dtcloud.service.wsgi_server.application
        ...
        with cls._lock:
            with dtcloud.api.Environment.manage():
                ...
                try:
                    ...
                    try:
                        dtcloud.modules.load_modules(registry._db, force_demo, status, update_module)
                    except Exception:
                        dtcloud.modules.reset_modules_state(db_name)
                        raise
                except Exception:
    ...
    def init(self, db_name):
        ...
        self._init = True
        self._assertion_report = dtcloud.tests.runner.DTCloudTestResult()
        ...
        self._db = dtcloud.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = dtcloud.modules.db.has_unaccent(cr)
    ...
    def init_models(self, cr, model_names, context, install=True):
        ...
        env = dtcloud.api.Environment(cr, SUPERUSER_ID, context)
