...
term representation was ['=', 'company_id.name', 'DTCloud']. Used in a
...
DTCloud will use the SQL function 'unaccent' when available for the
...
Finally, to instruct DTCloud to really use the unaccent function, you have to
...
import dtcloud.modules
from dtcloud.osv.query import Query
from dtcloud.tools import pycompat
from dtcloud.tools.misc import get_lang
...
def get_unaccent_wrapper(cr):
    if dtcloud.registry(cr.dbname).has_unaccent:
