...
from dtcloud import api, models, tools
from dtcloud.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
...
from dtcloud.addons.base.models.qweb import QWeb, Contextifier
from dtcloud.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from dtcloud.addons.web.controllers.main import module_boot
