...
from dtcloud.tools import pycompat, freehash
from dtcloud.tools.safe_eval import check_values
    ...
    def _base_module(self):
        ...
        * to_text (empty string for a None or False, otherwise unicode string)
        ...
        return ast.parse(dedent("""
            ...
            from dtcloud.addons.base.models.qweb import escape, foreach_iterator
            """))
