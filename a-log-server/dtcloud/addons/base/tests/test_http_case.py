...
from dtcloud.tests.common import HttpCase, tagged
from dtcloud.tools import mute_logger, logging
...
class TestHttpCase(HttpCase):
    ...
    def test_console_error_string(self):
        with self.assertRaises(AssertionError) as error_catcher:
            ...
            with patch('dtcloud.tests.common.ChromeBrowser.take_screenshot', return_value=None):
    ...
    def test_console_log_object(self):
        logger = logging.getLogger('dtcloud')
        level = logger.level
