...
import dtcloud
from dtcloud.exceptions import UserError, ValidationError, AccessError
...
class TestServerActions(TestServerActionsBase):
    ...
    @mute_logger('dtcloud.addons.base.models.ir_model', 'dtcloud.models')
    ...
    def test_80_permission(self):
        ...
        with self.assertRaises(AccessError), mute_logger('dtcloud.addons.base.models.ir_actions'):
            self_demo.with_context(self.context).run()
...
class TestCustomFields(common.TransactionCase):
    ...
    def test_create_unique(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('dtcloud.sql_db'):
            self.create_field('x_foo')
