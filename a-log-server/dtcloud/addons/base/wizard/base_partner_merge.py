...
from dtcloud import SUPERUSER_ID, _
from dtcloud.exceptions import ValidationError, UserError
from dtcloud.tools import mute_logger

_logger = logging.getLogger('dtcloud.addons.base.partner.merge')
...
class MergePartnerAutomatic(models.TransientModel):
    ...
    def _update_foreign_keys(self, src_partners, dst_partner):
        ...
        for table, column in relations:
            ...
            if len(columns) <= 1:
                ...
                try:
                    with mute_logger('dtcloud.sql_db'), self._cr.savepoint():
    ...
    def _update_reference_fields(self, src_partners, dst_partner):
        ...
        def update_records(model, src, field_model='model', field_id='res_id'):
            ...
            try:
                with mute_logger('dtcloud.sql_db'), self._cr.savepoint(), self.env.clear_upon_failure():
