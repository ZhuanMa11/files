...
from dtcloud.tools import config, DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, pycompat
...
class ImportMapping(models.Model):
    ...
    not match DTCloud's field names or labels. This model is used
    ...
    def get_fields(self, model, depth=FIELDS_RECURSION_LIMIT):
        ...
        .. class:: Field
            ...
            .. attribute:: name (str)
                ...
                The field's logical (DTCloud) name within the scope of
                its parent.
