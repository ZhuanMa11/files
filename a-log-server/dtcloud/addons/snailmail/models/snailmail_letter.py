...
from dtcloud import fields, models, api, _
from dtcloud.addons.iap.tools import iap_tools
from dtcloud.tools.safe_eval import safe_eval

DEFAULT_ENDPOINT = 'https://iap-snailmail.dtcloud360.com'
...
class SnailmailLetter(models.Model):
    ...
    def _get_error_message(self, error):
        ...
        if error == 'TRIAL_ERROR':
            ...
            return _('You don\'t have an IAP account registered for this service.<br>Please go to <a href=%s target="new">iap.dtcloud360.com</a> to claim your free credits.', link)
