dtcloud.define('web.UserMenu', function (require) {
"use strict";
...
var UserMenu = Widget.extend({
            ...
            callback: function () {
                self._rpc({route: '/web/session/account'})
                    ...
                    .guardedCatch(function (result, ev){
                        ev.preventDefault();
                        framework.redirect('https://accounts.dtcloud360.com/account');
                    });
            },
        });
    },
    ...
    _onMenuDocumentation: function () {
        window.open('https://www.dtcloud360.com/documentation/14.0', '_blank');
    },
    /**
     * @private
     */
    ...
    _onMenuSupport: function () {
        window.open('https://www.dtcloud360.com/buy', '_blank');
    },
    /**
     * @private
     */
