dtcloud.define('web.mixins', function (require) {
"use strict";
...
function DTCloudEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
DTCloudEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

DTCloudEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
     ...
     * DTCloud Web where developers may want to replace existing callbacks with
     * theirs.
     *
    ...
    trigger_up: function (name, info) {
        var event = new DTCloudEvent(this, name, info);
