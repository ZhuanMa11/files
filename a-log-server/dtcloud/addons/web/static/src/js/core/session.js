dtcloud.define('web.Session', function (require) {
"use strict";
...
var Session = core.Class.extend(mixins.EventDispatcherMixin, {
    ...
    init: function (parent, origin, options) {
        ...
        options = options || {};
        this.module_list = (options.modules && options.modules.slice()) || (window.dtcloud._modules && window.dtcloud._modules.slice()) || [];
        this.server = null;
    ...
    session_reload: function () {
        var result = _.extend({}, window.dtcloud.session_info);
