dtcloud.define('web.basic_fields', function (require) {
"use strict";
...
var InputField = DebouncedField.extend({
     ...
     *
     * @param {DTCloudEvent} event 'field_changed' event
     */
...
var FieldDateRange = InputField.extend({
    ...
    _applyChanges: function (ev, picker) {
        ...
        if (this.isDateField) {
            ...
            // time at 00:00:00. So, DTCloud will consider it as UTC. To fix this added browser
...
var FieldEmail = InputField.extend({
    ...
    _renderReadonly: function () {
        if (this.value) {
            // DTCloud legacy widgets can have multiple nodes inside their $el JQuery object
