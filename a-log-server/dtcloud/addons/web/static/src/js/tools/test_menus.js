(function (exports) {
    ...
    let isEnterprise = dtcloud.session_info.server_version_info[5] === 'e';

    function createWebClientHooks() {
        var AbstractController = dtcloud.__DEBUG__.services['web.AbstractController'];
        var DiscussWidget = dtcloud.__DEBUG__.services['mail/static/src/widgets/discuss/discuss.js'];
        var WebClient = dtcloud.__DEBUG__.services["web.WebClient"];
