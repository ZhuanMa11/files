...
from dtcloud.tests import TransactionCase, tagged, Form
from dtcloud.tools import frozendict, image_to_base64, hex_to_rgb
...
class TestBaseDocumentLayout(TestBaseDocumentLayoutHelpers):
    ...
    def test_company_no_color_but_logo_change_logo(self):
        ...
        with Form(self.env['base.document.layout']) as doc_layout:
            ...
            doc_layout.logo = self.company_imgs['dtcloud']['img']
            self.assertColors(doc_layout, self.company_imgs['dtcloud']['colors'])
