...
Also, adds methods to convert values back to DTCloud models.
"""
...
from dtcloud import api, models, fields
from dtcloud.tools import ustr, posix_to_ldml, pycompat
from dtcloud.tools import html_escape as escape
from dtcloud.tools.misc import get_lang, babel_locale_parse
from dtcloud.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = dtcloud.modules.get_module_resource(
