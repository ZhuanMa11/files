define([
  ...
  var range = (function () {
    ...
    var WrappedRange = function (sc, so, ec, eo) {
       ...
       * @return {WrappedRange}
       */
      if(_.isUndefined(this.deleteContents)) // dtcloud: ability to override by prototype
      ...
      this.wrapBodyInlineWithPara = function () {
        ...
        // dtcloud: insert a p tag when try to insert a br with insertNode method, if the editor is inside a p, li, h1... (start_modification
      ...
      this.insertNode = function (node) {
        ...
        // dtcloud: override to not split world for inserting inline
   ...
   */
    return {
      WrappedRange: WrappedRange, // dtcloud: give access to WrappedRange
      /**
       * @method
       * 
