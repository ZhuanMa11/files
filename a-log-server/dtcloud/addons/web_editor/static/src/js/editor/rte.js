dtcloud.define('web_editor.rte', function (require) {
'use strict';
...
var RTEWidget = Widget.extend({
    ...
    start: function () {
        ...
        .each(function () {
            ...
            // fallback for firefox iframe display:none see https://github.com/dtcloud/dtcloud/pull/22610
...
dtcloud.define('web_editor.rte.summernote_custom_colors', function (require) {
'use strict';
