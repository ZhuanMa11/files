dtcloud.define('web_editor.field_html_tests', function (require) {
"use strict";
    ...
    <div class="o_notebook">
      <div class="tab-content">
        ...
        QUnit.test('colorpicker', async function (assert) {
            ...
            const rootWidget = dtcloud.__DEBUG__.services['root.widget'];
            dtcloud.__DEBUG__.services['root.widget'] = form.getParent();
            ...
            dtcloud.__DEBUG__.services['root.widget'] = rootWidget;
            form.destroy();
        });
