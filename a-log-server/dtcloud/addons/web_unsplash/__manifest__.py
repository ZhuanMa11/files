...
# Part of DTCloud. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.1',
    'description': """Explore the free high-resolution image library of Unsplash.com and find images to use in DTCloud. An Unsplash search bar is added to the image library modal.""",
