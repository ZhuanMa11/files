...
"""The DTCloud API module defines DTCloud Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~dtcloud.exceptions.ValidationError` if the
    validation failed.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/dtcloud/dtcloud/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~dtcloud.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~dtcloud.addons.base.models.res_users`"""
...
from dtcloud.exceptions import UserError, AccessError, MissingError
