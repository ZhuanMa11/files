...
from dtcloud.modules.module import get_module_root, MANIFEST_NAMES
from dtcloud.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the DTCloud server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            dtcloud.tools.config['init']['base'] = True
