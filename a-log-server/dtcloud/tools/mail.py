...
import dtcloud
from dtcloud.loglevels import ustr
from dtcloud.tools import misc
...
def email_send(email_from, email_to, subject, body, email_cc=None, email_bcc=None, reply_to=False,
    ...
    :deprecate: since DTCloud 6.1, please use ir.mail_server.send_email() instead.
    ...
    if not cr:
        ...
        if db_name:
            local_cr = cr = dtcloud.registry(db_name).cursor()
        else:
            raise Exception("No database cursor found, please pass one explicitly")

    # Send Email
    try:
        mail_server_pool = dtcloud.registry(cr.dbname)['ir.mail_server']
        res = False
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@dtcloud360.com
    * Output:   "Admin (admin@gmail.com)" <notifications@dtcloud360.com>
    """
