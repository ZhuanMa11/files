...
class CommonApiGet(Api):
    ...
    def get_single_record(kw: dict):
        ...
        data_list = CommonApiDataConvert.api_page_data_convert_list(record, pool, access_token)
        return data_list, 5
    ...
    def get_records_by_domain(kw: dict):
        ...
        data_list = CommonApiDataConvert.api_page_data_convert_list(records, pool, access_token)
