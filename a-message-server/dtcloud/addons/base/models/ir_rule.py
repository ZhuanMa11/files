...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - dtcloud/addons/test_access_rights/tests/test_feedback.py
        # - dtcloud/addons/test_access_rights/tests/test_ir_rules.py
        # - dtcloud/addons/base/tests/test_orm.py (/home/dle/src/dtcloud/master-nochange-fp/dtcloud/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
