...
from dtcloud.tests.common import TransactionCase, BaseCase
from dtcloud.tools import mute_logger
from dtcloud.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('dtcloud.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import dtcloud", mode="exec")
