...
from dtcloud.addons.base.tests.common import SavepointCaseWithUserDemo
from dtcloud.fields import Date
from dtcloud.models import BaseModel
from dtcloud.tests.common import TransactionCase
from dtcloud.tools import mute_logger
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('dtcloud.osv.expression'):
    ...
    @mute_logger('dtcloud.models.unlink')
    ...
    def test_15_m2o(self):
        ...
        # that don't have DTCloud has a parent company, you expect to find,
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [(0, 0, {'name': 'address of DTCloud Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
