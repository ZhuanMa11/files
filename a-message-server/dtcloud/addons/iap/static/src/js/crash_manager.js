dtcloud.define('iap.CrashManager', function (require) {
"use strict";
...
CrashManager.include({
    ...
    _getButtonMessage: function (isTrial){
        var isEnterprise = _.last(dtcloud.session_info.server_version_info) === 'e';
        return isTrial && isEnterprise ? _t('Start a Trial at DTCloud') : _t('Buy credits');
    },
    /**
     * @override
     */
    rpc_error: function (error) {
        var self = this;
        if (error.data.name === "dtcloud.addons.iap.tools.iap_tools.InsufficientCreditError") {
            ...
            ajax.jsonRpc('/web/dataset/call_kw', 'call', {
                ...
                var content = $(QWeb.render('iap.redirect_to_dtcloud_credit', {
                        data: error_data,
                    }));
                if (error_data.body) {
