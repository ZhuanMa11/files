...
from dtcloud import exceptions, _
from dtcloud.tests.common import BaseCase
from dtcloud.tools import pycompat

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap.dtcloud360.com'
...
iap_patch = patch('dtcloud.addons.iap.tools.iap_tools.iap_jsonrpc', iap_jsonrpc_mocked)
