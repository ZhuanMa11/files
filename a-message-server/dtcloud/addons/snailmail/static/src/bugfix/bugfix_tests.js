dtcloud.define('snailmail/static/src/bugfix/bugfix_tests.js', function (require) {
'use strict';
 ...
 * components for instance in stable versions of DTCloud. Any test that is defined
