...
from dtcloud.addons.base.tests.common import TransactionCaseWithUserDemo
from dtcloud.tests import common, tagged
...
record['name'] = record.name + 'X'""",
    ...
    def test_11b_recomputed_field(self):
        ...
        patchers = [
            patch('dtcloud.addons.base_automation.models.base_automation.BaseAutomation._get_actions', _patched_get_actions),
            patch('dtcloud.addons.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail),
        ]
