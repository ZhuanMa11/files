...
Client actions are the client-side version of DTCloud's "Server
...
In the DTCloud Web code, a client action only requires two pieces of
information:
...
* Providing said object. Two different types of objects can be mapped
  ...
  * An DTCloud Web widget, which must inherit from
