dtcloud.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that DTCloud actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute DTCloud actions, given as an ID in
