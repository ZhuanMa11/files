dtcloud.define('web.ajax', function (require) {
"use strict";
...
function get_file(options) {
    ...
    xhr.onload = function () {
        ...
        decoder.onload = function () {
            ...
            try { // Case of a serialized DTCloud Exception: It is Json Parsable
...
var loadAsset = (function () {
    ...
    var load = function loadAsset(xmlId, context, tplRoute = '/web/dataset/call_kw/') {
        ...
        context = _.extend({}, dtcloud.session_info.user_context, context);
        const params = {
            args: [xmlId, {
