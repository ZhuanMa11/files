dtcloud.define('web.mvc', function (require) {
"use strict";

/**
 * This file contains a 'formalization' of a MVC pattern, applied to DTCloud
 * idioms.
 *
 * For a simple widget/component, this is definitely overkill.  However, when
 * working on complex systems, such as DTCloud views (or the control panel, or some
 ...
 * main issue is that the term 'View' is used way too much in DTCloud land, and
