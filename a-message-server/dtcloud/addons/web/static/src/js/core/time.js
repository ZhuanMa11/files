dtcloud.define('web.time', function (require) {
"use strict";
 ...
 * datetime in the DTCloud Server format.
 *
...
/**
 * Converts a string to a Date javascript object using DTCloud's
 * datetime string format (exemple: '2011-12-01 15:12:35.832').
 * 
 * The time zone is assumed to be UTC (standard for DTCloud 6.1)
 ...
 * 
 * The DTCloud times are supposed to always be naive times. We assume it is
...
/**
 * Converts a Date javascript object to a string using DTCloud's
 * datetime string format (exemple: '2011-12-01 15:12:35').
 * 
 * The time zone of the Date object is assumed to be the one of the
 * browser and it will be converted to UTC (standard for DTCloud 6.1).
 * 
 * @param {Date} obj
