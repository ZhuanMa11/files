dtcloud.define('web.relational_fields', function (require) {
"use strict";
...
var FieldX2Many = AbstractField.extend(WidgetAdapterMixin, {
     ...
     * @override
     * @param {Object} record
     * @param {DTCloudEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {DTCloudEvent|MouseEvent} ev this event comes either from the 'Add
