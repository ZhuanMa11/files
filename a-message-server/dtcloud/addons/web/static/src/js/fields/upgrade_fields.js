dtcloud.define('web.upgrade_widgets', function (require) {
"use strict";
...
var AbstractFieldUpgrade = {
    ...
    /**
     * Redirects the user to the dtcloud-enterprise/uprade page
     *
     * @private
     * @returns {Promise}
     */
    _confirmUpgrade: function () {
        return this._rpc({
            ...
            .then(function (data) {
                framework.redirect("https://www.dtcloud360.com/dtcloud-enterprise/upgrade?num_users=" + data);
            });
    },
    /**
