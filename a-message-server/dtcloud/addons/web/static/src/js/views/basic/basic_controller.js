dtcloud.define('web.BasicController', function (require) {
"use strict";
...
var BasicController = AbstractController.extend(FieldManagerMixin, {
     ...
     * @param {DTCloudEvent} e - the event that triggered the change
     * @returns {Promise}
     */
    ...
    _onContentClicked(ev) {
        if (this.$buttons && this._shouldBounceOnClick(ev.target)) {
            this.$buttons.find('.btn-primary:visible:first').dtcloudBounce();
        }
    },
    /**
