 ...
 * QUnit Config
 *
 * The DTCloud javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * DTCloud.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an DTCloud module, because we want this code to be executed
 * as soon as possible, not whenever the DTCloud module system feels like it.
 */
 ...
 * this is done outside of dtcloud modules, otherwise the setting would not take
 * effect on time.
 */
...
async function checkModules() {
    ...
    await dtcloud.__DEBUG__.didLogInfo;

    const info = dtcloud.__DEBUG__.jsModules;
 ...
 */
QUnit.on('DTCloudAfterTestHook', function (info) {
    const toRemove = [];
