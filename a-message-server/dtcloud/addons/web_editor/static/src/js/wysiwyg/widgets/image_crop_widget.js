dtcloud.define('wysiwyg.widgets.ImageCropWidget', function (require) {
'use strict';
    ...
    async start() {
        if (this.uncroppable) {
            this.displayNotification({
              ...
              message: _t("This type of image is not supported for cropping.<br/>If you want to crop it, please first download it from the original source and upload it in DTCloud."),
            });
            return this.destroy();
        }
